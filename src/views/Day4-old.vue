          ...
          <div class="card-body">
            ...
            <form class="row g-3 needs-validation" @submit.prevent="_onSubmit">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="validationCustom02" v-model.trim.lazy="user.lastName" />
              ...
              <div class="col-md-4">
                ...
                <v-select v-model="user.countryCode" label="name" :options="countryCodes">
